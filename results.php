...
include("head.php");
//echo "<b><u>Welcome.Mr\" ".$_SESSION['user']."</b></u><a href=\"logout.php\" id=\"\">Log-Out</a>   "."<a href=\"update_profile.php\">Update - Profile</a>";
?>
<style>
#wt
{
...
$q3="select * from stud natural join $selection  where uname=\"$id\";";
$res=mysql_query("$q3");
if(!$res){echo "<br/><br><blink>Enter the Valid ID No</blink><br>".mysql_error();}
while($row=mysql_fetch_array($res))
{
?>
	<p align="center"><b>Student Details</b></p>
...
<p align="center"><b>Student Marks Record</b></p>
...
<tr><td id="sl">1</td><td id="code">MA2101</td><td id="sun_name">Maths-II Descrete Structures</td><td id="marks"><?php echo $row['ma'];?></td></tr>
<tr><td id="sl">2</td><td id="code">CS2102</td><td id="sun_name">Design of Algorithms </td><td id="marks"><?php echo $row['doa'];?></td></tr>
<tr><td id="sl">3</td><td id="code">EC2101</td><td id="sun_name">Introduction to Electronics </td><td id="marks"><?php echo $row['ie'];?></td></tr>
<tr><td id="sl">4</td><td id="code">EC2102</td><td id="sun_name">Network Theory</td><td id="marks"><?php echo $row['nt'];?></td></tr>
<tr><td id="sl">5</td><td id="code">CS2701</td><td id="sun_name">Design of Algorithms Lab </td><td id="marks"><?php echo $row['dal'];?></td></tr>
<tr><td id="sl">6</td><td id="code">EC2701</td><td id="sun_name"> Introduction to Electronics Lab</td><td id="marks"><?php echo $row['iel'];?></td></tr>
<tr><td id="sl">7</td><td id="code">EC2702</td><td id="sun_name">Network Theory Lab </td><td id="marks"><?php echo $row['ntl'];?></td></tr>
<tr><td id="sl">8</td><td id="code">HS2101</td><td id="sun_name">Human Values </td><td id="marks"><?php echo $row['hv'];?></td></tr>
<tr id="sun_name1"><td id="sl">9</td><td id="code"> - </td><td id="sun_name">Total Marks</td><td id="marks"><?php echo $row['ma']+$row['doa']+$row['ie']+$row['nt']+$row['dal']+$row['iel']+$row['ntl']+$row['hv'];?></td></tr>
</table>
<br/>
<center>
<?php
